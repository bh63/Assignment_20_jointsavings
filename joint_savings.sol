...
contract JointSavings {
    ...
    */
    ...
    uint public balance; //needed for 
    ...
    */
    function withdraw(uint amount, address payable recipient) public {
        ...
        /*
        Define a `require` statement that checks if `recipient` is equal to either `accountOne` or `accountTwo`. 
        If it isn’t, the `require` statement returns the “You don't own this account!” text
        */
        ...
        If there are insufficient funds, it returns the “Insufficient funds!” text
        */
        require(contractBalance >= amount, "Insufficient funds!");
            // might use balance or contractbalance here
        /*
        Add an `if` statement to check if `lastToWithdraw` is not equal to (`!=`) to `recipient`.
        If it’s not equal, set it to the current value of `recipient`
        */
